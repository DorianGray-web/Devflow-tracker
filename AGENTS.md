...
## Snapshot
- **Package / name:** Engram (Engineering Memory Platform)
...
**Product clarifications (aligned with all docs)**:
- **Product name**: Engram
...
- **Project repo vs Engineering Memory workspace**: Git repo = product code; `.engram/` = engineering memory.